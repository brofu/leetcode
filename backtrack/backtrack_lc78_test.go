...
func Test_subsetsV5(t *testing.T) {
	type args struct {
		nums []int
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := subsetsV5(tt.args.nums); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("subsetsV5() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_subsetsV6(t *testing.T) {
	type args struct {
		nums []int
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := subsetsV6(tt.args.nums); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("subsetsV6() = %v, want %v", got, tt.want)
			}
		})
	}
}
