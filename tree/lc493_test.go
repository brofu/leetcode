...
func Test_reversePairs(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "lc case 4",
			args: args{
				nums: []int{233, 2000000001, 234, 2000000006, 235, 2000000003, 236, 2000000007, 237, 2000000002, 2000000005, 233, 233, 233, 233, 233, 2000000004},
			},
			want: 40,
		},
		{
...
func Test_reversePairsV2(t *testing.T) {
	type args struct {
		nums []int
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := reversePairsV2(tt.args.nums); got != tt.want {
				t.Errorf("reversePairsV2() = %v, want %v", got, tt.want)
			}
		})
	}
}
